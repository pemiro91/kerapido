    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('municipio',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='municipios_ordered',
                                   to='kerapido.Municipio')),
            ],
        ),
        migrations.CreateModel(
            name='PerfilAfiliado',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categorias_ordered',
                                   to='kerapido.Categoria_Producto')),
            ...
            fields=[
                ...
                ('afiliado_pertenece',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                   to='kerapido.PerfilAfiliado')),
                ('negocio_pertenece',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kerapido.Negocio')),
                ('persona_encargada',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('servicio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                               to='kerapido.Servicio')),
                ('tarifa', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                             to='kerapido.Tarifa_Entrega')),
            ],
        ),
        migrations.CreateModel(
            name='Oferta_Laboral',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo',
                 models.CharField(choices=[('Negocio', 'Negocio'), ('Pedido', 'Pedido'), ('Usuario', 'Usuario')],
                                  max_length=50)),
                ('fecha', models.DateTimeField(auto_now_add=True)),
                ('negocio',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='kerapido.Negocio')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                              to=settings.AUTH_USER_MODEL)),
                ('negocio', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                              to='kerapido.Negocio')),
            ],
        ),
        migrations.AddField(
