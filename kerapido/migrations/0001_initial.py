# Generated by Django 3.0.6 on 2020-07-17 05:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persona_encargada', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('imagen', models.ImageField(blank=True, null=True, upload_to='imagen_plato/%Y/%m/%d')),
                ('nombre', models.CharField(max_length=255)),
                ('descripcion', models.CharField(max_length=255)),
                ('precio', models.CharField(max_length=255)),
                ('negocio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kerapido.PerfilNegocio')),
            ],
        ),
        migrations.CreateModel(
            name='Tarifa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('agregos', models.CharField(blank=True, max_length=255, null=True)),
                ('plato', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='kerapido.Plato')),
            ],
        ),
        migrations.CreateModel(
